...
<?php include 'header.php' ?>
    ...
    $result =$p->afficherproduitbycategorie($_GET['categorie'],$page_1);
    $top =$p->top5();
    $categories =$c->selectcategorie();
    $count=ceil(($p->countbycategorie($_GET['categorie']))/6);
				...
				<div id="main" class="col-md-9">
						...
						<div class="pull-right">
							...
							<ul class="store-pages">
                                ...
                                <?php
                                    ...
                                    for($i=1;$i<=$count;$i++) {
                                        if($i==$page)
                                        { echo "<li> <a style='color: orangered' href='productsbycategorie.php?categorie={$c}&page={$i}'>{$i}</a> </li>  " ; }
                                        else {  echo "<li> <a href='productsbycategorie.php?categorie={$c}&page={$i}'>{$i}</a> </li>  " ;}
					...
					<div id="store">
						...
						<div class="row">
                            ...
                            <?php
                            $count2=ceil(($p->countbycategorie($_GET['categorie'])));
                            if ($count2==0)
                            {?>
                                <H2 style="color: red" >SORRY WE HAVE NO PRODUCT IN THIS CATEGORIE</H2>
                            <?php} else{ ?>
