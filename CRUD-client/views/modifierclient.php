...
if (isset($_POST['modifier'])){
	$client=new client($_POST['id_client'],$_POST['nom_client'],$_POST['prenom_client'],$_POST['mdp_client'],$_POST['telephone_client'],$_POST['adresse_client'],$_POST['ville_client']);
