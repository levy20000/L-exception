			...
			<div class="row">
                <div class="body-container">
                    ...
                    <div class="auth-page-container">
                        ...
                        <div class="wrapper">
                            <form class="form-signin"  method="post"  action="../core/check_acc.php">
                                <h2 class="form-signin-heading">Please login</h2>
                                <input type="text" class="form-control"  placeholder="Email Address" name="email"id="email"  required  autofocus="" />
                                <br>
                                <input type="password" class="form-control"  placeholder="Password"  id="pwd" name="pass" required />
<br>
                                <a  href="join.php"> <span>Pas encore membre ? </span></a>
                                <a  href="reset.php"><span> Mot de passe oublié?</span></a>
                                <br>
                                <br>
