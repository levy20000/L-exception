...
<div class="wrapper">
    ...
    require_once '../../core/produitM.php';
    include 'sidebar.php';
    $promotionM = new PromotionM();
    $produitM = new produitM();
    if (isset($_POST['pourcentage'])){
        $promotion = new Promotion($_POST['pourcentage'],$_POST['id_produit'],$_POST['date_debut'],$_POST['date_fin']);
        $promotionM->ajoutPromotion($promotion);
    }
    $liste = $promotionM->getPromotions();
    $listeProduit = $produitM->getProduits();
    ?>
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                foreach ($liste as $val) {
                                    ?>
                                    <tr>
                                        <td><?php echo $val['id_prom'] ?></td>
                                        <td><?php echo $val['id_produit'] ?></td>
                                        <td><?php echo $val['pourcentage'] ?></td>
                                        <td><?php echo $val['date_debut'] ?></td>
                                        <td><?php echo $val['date_fin'] ?></td>
                                        <td><a class="btn btn-block btn-danger" href="supprimerPromotion.php?id_prom=<?php echo $val['id_prom'] ?>">Supprimer</a></td>
                                    </tr>
                                    <?php
                                }
                                ?>
                            ...
                            <form role="form" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="pourcentage" placeholder="Pourcentage">
                                    </div>
                                    <div class="form-group">
